          ...
          <Row>
            ...
            <Col lg={{ span: 16 }} span={24}>
              ...
              >
                ...
                <Panel
                  header="It's past the estimated delivery date and I have yet to recieve my item. How can I contact the seller?"
                  key="2"
                >
                  <p style={{ paddingLeft: 24 }}>
                    You can send us an email
                    <Link to={`/contactUs`}> here </Link>
                    and provide us with details of your order. Expect at least 3 days of waiting time as we have many
                    queries to look through. We apologise for the inconvenience and will reach out to the Seller for
                    you.
                  </p>
                </Panel>
              </Collapse>
